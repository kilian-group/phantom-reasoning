...
subcategoriesthree = {
    "Festivals": {
        ...
        "Random": [
            "Taylor Movie Festival",
            "Verdi Movie Festival",
            "West Sahara Movie Festival",
            "Northwood Movie Festival",
            "Golden Banana Movie Festival",
        ],
        # "Comedy": ["Mia Lark", "Oscar Bloom", "Nina Wilde", "Felix Grant", "Dana Sparks"],
        "French": [
            "Festival Lumière de Valmont",
            "Rêves de Belleville",
            "Cinéma de Montreval",
            "Festival de Clairmont",
            "Festival de Saint-Rivage",
        ],
    },
