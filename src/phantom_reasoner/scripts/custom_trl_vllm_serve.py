"""
Implementation from https://github.com/huggingface/trl/blob/main/trl/scripts/vllm_serve.py
We modify the original script to add support for the flags:
- --enable_reasoning
- --reasoning_parser
"""
...
class ScriptArguments:
    ...
    enable_reasoning: bool = field(
        default=False,
        metadata={"help": "Whether to enable reasoning, passed to vllm serve API creator."},
    )
    reasoning_parser: str | None = field(
        default=None,
        metadata={
            "help": "The reasoning parser to use for the model. If not set, the default parser will be used. "
            "This is useful for models e.g. Qwen3 that require a specific reasoning parser."
        },
    )
...
def llm_worker(
    ...
    llm = LLM(
        ...
        worker_extension_cls="phantom_reasoner.scripts.custom_trl_vllm_serve.WeightSyncWorkerExtension",
