...
def shuffle_tensor_dict(tensor_dict: dict[str, torch.Tensor | None]) -> dict[str, torch.Tensor | None]:
    """
...
class CustomGRPOTrainer(Trainer):
    ...
    def __init__(
        ...
        eval_dataset: None | (Dataset | IterableDataset | dict[str, Dataset | IterableDataset]) = None,
        processing_class: PreTrainedTokenizerBase | None = None,
        reward_processing_classes: None | (PreTrainedTokenizerBase | list[PreTrainedTokenizerBase]) = None,
    ...
    def _generate_and_score_completions(
        ...
        if self.max_prompt_length is not None:
            ...
            # NOTE: @anmolkabra: DO NOT remove special tokens otherwise vllm won't receive the chat template
