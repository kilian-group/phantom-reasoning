#!/usr/bin/env bash
#SBATCH --job-name=grpo_gsm
#SBATCH --output=logs/grpo_gsm-%j.out
#SBATCH --error=logs/grpo_gsm-%j.err
#SBATCH -p kilian
#SBATCH -N 1
#SBATCH -n 8
...
# Get CUDA visible devices as 0,...,NUM_GPUS-1 (0 indexing, and last one is reserved for vllm)
