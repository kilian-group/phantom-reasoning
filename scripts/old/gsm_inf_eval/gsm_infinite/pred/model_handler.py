...
class ModelHandler:
    ...
    def generate_answer(self, prompt: str | list[str], **kwargs) -> str | dict[str, Any]:
        if self.model_type == "openai":
        ...
        **kwargs,
        ...
        messages = (
            [
                ...
                # focused on providing accurate and detailed responses."},
        ...
        **kwargs,
        ...
        try:
            ...
            def convert_chat_history(openai_messages):
                ...
                Returns:
                    A tuple containing the Gemini-style chat history (list of dictionaries) and
            ...
            gemini_history, system_prompt, user_input = convert_chat_history(messages)
