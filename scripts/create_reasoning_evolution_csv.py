...
Usage:
    python create_reasoning_evolution_csv.py [OPTIONS]

    # Run with defaults (pw train, msq500 eval, training_seed=1)
    python create_reasoning_evolution_csv.py

    # Run on hp dataset with all seeds
    python create_reasoning_evolution_csv.py --train-dataset hp --eval-dataset hp500 --training-seed -1

    # Specify custom output
    python create_reasoning_evolution_csv.py --output-filename my_results.csv
...
# Add examples/wiki/utils to path for data_utils import
sys.path.insert(0, os.path.join(os.path.dirname(__file__), "..", "examples", "wiki", "utils"))
