...
filename_pattern = re.compile(r"^result_(?P<dataset>[A-Za-z0-9_\.]+)_(?P<model>[A-Za-z0-9=_\-\.]+)\.txt$")
        ...
        try:
            with open(filepath) as file:
                for line in file:
                    ...
                    has_subset_info = any("template:" in part for part in parts) or any(
                        "mode:" in part for part in parts
                    )
...
print(tabulate(model_accuracy, headers="keys", tablefmt="github"))
