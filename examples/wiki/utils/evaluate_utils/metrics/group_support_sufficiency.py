...
class GroupSupportSufficiencyMetric(GroupMetric):
    ...
    def compute_question_scores(self, group: GoldPredictionInstance) -> dict[str, float]:
        ...
        self.support_metric(group.predicted_supporting_facts, group.gold_supporting_facts)
    ...
    def __call__(
        ...
        if gold_sufficiency == 1:
            self.prediction_store[question_id].gold_supporting_facts = gold_supporting_facts
